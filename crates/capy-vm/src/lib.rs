...
pub use error::{
    ...
    V_CONST_OUT_OF_BOUNDS, V_DIVISION_BY_ZERO, V_EXPECTED_BOOL, V_FIELD_OUT_OF_BOUNDS,
    V_HOST_CALL_FAILED, V_INDEX_OUT_OF_BOUNDS, V_JUMP_OUT_OF_BOUNDS, V_LOCAL_OUT_OF_BOUNDS,
    V_MALFORMED_MODULE, V_POP_EMPTY_ARRAY, V_STACK_UNDERFLOW, V_TYPE_MISMATCH, V_UNKNOWN_FUNCTION,
    V_UNKNOWN_FUNCTION_INDEX, V_UNKNOWN_HOST_IMPORT, V_UNRESOLVED_HOST_IMPORT,
};
