...
mod tests {
    ...
    fn opcode_byte_values_are_unique() {
        let bytes: Vec<u8> = [
            Opcode::Nop, Opcode::Pop, Opcode::LoadConst, Opcode::LoadTrue,
            Opcode::LoadFalse, Opcode::LoadNone, Opcode::LoadLocal, Opcode::StoreLocal,
            Opcode::Add, Opcode::Sub, Opcode::Mul, Opcode::Div, Opcode::Mod, Opcode::Neg,
            Opcode::Eq, Opcode::Ne, Opcode::Lt, Opcode::Le, Opcode::Gt, Opcode::Ge,
            Opcode::Not, Opcode::Jump, Opcode::JumpIfFalse, Opcode::Call, Opcode::Return,
            Opcode::HostCall,
        ]
        .iter()
        .map(|o| o.as_byte())
